...
import glowRed from "../../assets/glow-red.webp";
import heroRed from "../../assets/saied-red.webp";
    ...
    <section className="hero">
      ...
      <div className="hero__offer container">
        <Banner
          ...
          details={
            <Fragment>
              Book Saied now and get <s style={{ opacity: 0.6 }}>75%</s>{" "}
              <strong> 100%</strong> discount for your first date check
            </Fragment>
          }
          footer={
